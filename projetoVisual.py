...
if __name__ == '__main__':
    while True:
        print(50 * '=')
        print(
            "Em qual diretório você deseja salvar as imagens?\ne.g. C:/Users/daniel/Desktop/images \n(you can use \ as well)\nDON'T USE ''")
        print('')
        directory = str(input('Diretorio: '))
        print('')
        search = str(input('Qual imagem voce deseja fazer o download? '))
        print('')
        num_of_img = int(input('Quantas imagens voce deseja fazer o download? '))
        print('')
        print('Downloading...Verifique seu diretório')

        google_images_download(directory, search, num_of_img)

        exit_question = str(input('Você quer sair? [Y/N]'))
